...
socket_ins.installPostgres = function (socket) {
    var install_process = child_process.spawn('./shell_scripts/' + _osId + '/install_postgresql.sh', [_osArchitecture]);
...
socket_ins.installRedis = function (socket) {
    var install_process = child_process.spawn('./shell_scripts/' + _osId + '/install_redis.sh');
...
socket_ins.installNginx = function (socket) {
    var install_process = child_process.spawn('./shell_scripts/' + _osId + '/install_nginx.sh');
...
socket_ins.installPm2 = function (socket) {
    var install_process = child_process.spawn('./shell_scripts/' + _osId + '/install_pm2.sh');
