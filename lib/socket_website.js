...
socket_website.create = function (socket, form) {
    var create_process = child_process.spawn('./shell_scripts/website/new_website.sh', [_osId, _osVersion, form[0].value, form[1].value, form[2].value, form[3].value, form[4].value]);
